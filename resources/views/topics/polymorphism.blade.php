...
<main>
    ...
    <p class="text"><strong>Ad hoc</strong> (лат. «специально для этого») - вид полиморфизма, в котором полиморфная
        функция может работать с аргументами различного типа за счет переопределения. То есть одноименные функции с
        различными типами аргументов распознаются как разные функции:</p>
    <pre><code>func Foo(int $varName) {
    // Do some
}
...
func Foo(string $varName) {
    ...
    <p class="text"><strong>Parametric</strong> (лат. «параметрический») - вид полиморфизма, в котором функция или класс
        могут работать с аргументами различного типа за счет использования шаблонов. То есть одноименные функции с
        различными типами аргументов распознаются как одна функция:</p>
    <pre><code>func Foo($varName) {
    ...
    <p class ="text"><strong>Полиморфизм подтипов</strong>- Полиморфизм включения (inclusion polymorphism) является
        обобщённой формализацией подтипизации и наследования. То есть функция умеет работать с конкретным типом
        и всеми его наследниками.</p>
</main>
</body>
<script>
    const themeMap = {
